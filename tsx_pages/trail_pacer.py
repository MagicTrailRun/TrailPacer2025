...
def show():
    ...
    with plan_course1:
        ...
        track_file = Path(f"data/TrailPacer/{event}/{course}/tracks/track_{year}.json")
        if track_file.exists():
            df_gpx = load_gpx(track_file)
    ...
    with explorer3 : 
        try :        
            ...
            df_gpx=load_gpx(f"data/TrailPacer/{event}/{course}/tracks/track_{year}.json")
